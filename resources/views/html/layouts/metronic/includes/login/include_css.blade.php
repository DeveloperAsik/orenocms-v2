...
<link href="{{config('app.base_url_assets_templates')}}/metronic/assets/admin/pages/css/login-soft.css" rel="stylesheet" type="text/css"/>
...
<link href="{{config('app.base_url_assets_templates')}}/metronic/assets/admin/layout/css/themes/darkblue.css" id="style_color" rel="stylesheet" type="text/css"/>
