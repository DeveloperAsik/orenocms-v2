...
<script src="{{config('app.base_url_assets_templates')}}/metronic/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<script src="{{config('app.base_url_assets_templates')}}/metronic/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
...
<script src="{{config('app.base_url_assets_templates')}}/metronic/assets/admin/pages/scripts/login-soft.js" type="text/javascript"></script>
