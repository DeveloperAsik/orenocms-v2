...
class Tbl_a_uac_groups_p_en extends Tbl_a_uac_groups_p {
                        ...
                        foreach ($data_level_1 AS $key1 => $value1) {
                            ...
                            if (isset($data_level_2) && !empty($data_level_2)) {
                                foreach ($data_level_2 AS $key2 => $value2) {
                                        ...
                                        foreach ($data_level_3 AS $key2 => $value3) {
                                            ...
                                            if (isset($data_level_4) && !empty($data_level_4)) {
                                                ...
                                                foreach ($data_level_4 AS $key4 => $value4) {
                                                        ...
                                                        foreach ($data_level_5 AS $key5 => $value5) {
                                                            ...
                                                            if (isset($data_level_6) && !empty($data_level_6)) {
                                                                ...
                                                                foreach ($data_level_6 AS $key6 => $value6) {
                                                                    ...
                                                                    $__is_open6 = false; //($value6->__is_open) ? true : false;
                                                                    $__is_disabled6 = false; //($value6->__is_disabled) ? true : false;
                                                                    $child_level_5[] = [
                                                                        'id' => $value6->id,
                                                                        'text' => $value6->__name,
                                                                        'icon' => $value6->__icon,
                                                                        'level_id' => $value6->__level,
                                                                        'parent_id' => $value6->__uac_group_parent_id,
                                                                        'state' => [
                                                                            'opened' => $__is_open6,
                                                            ...
                                                            $__is_open5 = false; //($value5->__is_open) ? true : false;
                                                            $__is_disabled5 = false; //($value5->__is_disabled) ? true : false;
                                                            $child_level_5[] = [
                                                                'id' => $value5->id,
                                                                'text' => $value5->__name,
                                                                'icon' => $value5->__icon,
                                                                'level_id' => $value5->__level,
                                                                'parent_id' => $value5->__uac_group_parent_id,
                                                                'state' => [
                                                                    'opened' => $__is_open5,
                                                    ...
                                                    $__is_open4 = false; //($value4->__is_open) ? true : false;
                                                    $__is_disabled4 = false; //($value4->__is_disabled) ? true : false;
                                                    $child_level_4[] = [
                                                        'id' => $value4->id,
                                                        'text' => $value4->__name,
                                                        'icon' => $value4->__icon,
                                                        'level_id' => $value4->__level,
                                                        'parent_id' => $value4->__uac_group_parent_id,
                                                        'state' => [
                                                            'opened' => $__is_open4,
                                            ...
                                            $__is_open3 = false; //($value3->__is_open) ? true : false;
                                            $__is_disabled3 = false; //($value3->__is_disabled) ? true : false;
                                            $child_level_3[] = [
                                                'id' => $value3->id,
                                                'text' => $value3->__name,
                                                'icon' => $value3->__icon,
                                                'level_id' => $value3->__level,
                                                'parent_id' => $value3->__uac_group_parent_id,
                                                'state' => [
                                                    'opened' => $__is_open3,
                                    ...
                                    $__is_open2 = false; //($value2->__is_open) ? true : false;
                                    $__is_disabled2 = false; //($value2->__is_disabled) ? true : false;
                                    $child_level_2[] = [
                                        'id' => $value2->id,
                                        'text' => $value2->__name,
                                        'icon' => $value2->__icon,
                                        'level_id' => $value2->__level,
                                        'parent_id' => $value2->__uac_group_parent_id,
                                        'state' => [
                                            'opened' => $__is_open2,
                            ...
                            $__is_open = true; //($value1->__is_open) ? true : false;
                            $__is_disabled = false; //($value1->__is_disabled) ? true : false;
                            $data_child_1[] = [
                                'id' => $value1->id,
                                'text' => $value1->__name,
                                'icon' => $value1->__icon,
                                'level_id' => $value1->__level,
                                'parent_id' => $value1->__uac_group_parent_id,
                                'state' => [
                                    'opened' => $__is_open,
    ...
    public function __fetch_tree_view_data($request, $level = '', $parent = '') {
        ...
        if ($level != '') {
            ...
            if ($parent != '') {
                $cond2 = [
                    ['a.__uac_group_parent_id', '=', $parent]
                ];
            }
            $conditions = [
    ...
    public function __fetch_last_rank($request, $parent_id = null) {
        ...
        if ($parent_id != '') {
            $params = [
                ...
                'conditions' => [
                    'where' => [
                        ['a.__uac_group_parent_id', '=', $parent_id]
                    ]
                ]
            ];
