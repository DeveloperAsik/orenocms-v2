...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2026 at 05:36 AM
...
--
-- Table structure for table `tbl_a_uac_groups_p`
--
...
--
-- Dumping data for table `tbl_a_uac_groups_p`
--
...
--
-- Table structure for table `tbl_a_uac_menu_p`
--
...
--
-- Dumping data for table `tbl_a_uac_menu_p`
--
...
--
-- Table structure for table `tbl_a_uac_modules_p`
--
...
--
-- Dumping data for table `tbl_a_uac_modules_p`
--
...
--
-- Table structure for table `tbl_a_uac_permissions_p`
--
...
--
-- Dumping data for table `tbl_a_uac_permissions_p`
--
...
(14, 'aaaa000', 'extraweb-master-uac-users-update', 'extraweb/master/uac/users/update/{id}', 'extraweb/master/uac/users/update/{id}', 'UserController', 'update', 'post', 'extraweb', 'master', 'uac', 'users', 'update', '{id}', '', 1, 0, 1, 1, '2025-12-29 11:53:44', 1, '2025-12-29 11:53:44'),
...
--
-- Table structure for table `tbl_a_uac_users_p`
--
...
--
-- Dumping data for table `tbl_a_uac_users_p`
--
...
--
-- Table structure for table `tbl_a_uac_user_login_attempts_c`
--
...
--
-- Table structure for table `tbl_a_uac_user_profiles_c`
--
...
--
-- Table structure for table `tbl_a_uac_user_registered_type_c`
--
...
--
-- Dumping data for table `tbl_a_uac_user_registered_type_c`
--
...
--
-- Table structure for table `tbl_a_uac_user_token_c`
--
...
--
-- Dumping data for table `tbl_a_uac_user_token_c`
--
...
(5, 'IntcInR5cFwiOlwiSldUXCIsXCJhbGdcIjpcIkhTMjU2XCJ9Ig..qoX1Q30jGuwxrJ6bGlbmHnXmcYbFGXaxnsIsaY_lDrY', '69a640adc56a2', '2026-03-03 15:00:57', 1, 1, 1, 0, 1, 1, '2026-03-03 09:00:57', 1, '2026-03-03 09:00:57'),
(6, 'IntcInR5cFwiOlwiSldUXCIsXCJhbGdcIjpcIkhTMjU2XCJ9Ig..IgccJ95o4CRIT39KDy23jdHIORar-OwTR6yZYeaQx00', '69a8e4c360fa2', '2026-03-05 15:05:40', 1, 1, 1, 0, 1, 1, '2026-03-05 09:05:40', 1, '2026-03-05 09:05:40'),
(7, 'IntcInR5cFwiOlwiSldUXCIsXCJhbGdcIjpcIkhTMjU2XCJ9Ig..x_JIUtNdsdEiogsc37X1CWTsH1SAhA4ipD38UQnIJnc', '69ae17cb03612', '2026-03-09 13:44:58', 1, 1, 1, 0, 1, 1, '2026-03-09 07:44:58', 1, '2026-03-09 07:44:58'),
(8, 'IntcInR5cFwiOlwiSldUXCIsXCJhbGdcIjpcIkhTMjU2XCJ9Ig..xw-xyMZu3GgJCm8s5IN02xamD1H8RW0o61oIUagio-w', '69b0b7e3757a9', '2026-03-11 13:34:37', 1, 1, 1, 0, 1, 1, '2026-03-11 07:34:37', 1, '2026-03-11 07:34:37');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_b_uac_group_permissions_r`
--
...
--
-- Dumping data for table `tbl_b_uac_group_permissions_r`
--
...
--
-- Table structure for table `tbl_b_uac_menu_permissions_r`
--
...
--
-- Table structure for table `tbl_b_uac_user_group_c`
--
...
--
-- Dumping data for table `tbl_b_uac_user_group_c`
--
...
--
-- Table structure for table `tbl_b_uac_user_permissions_r`
--
...
--
-- Dumping data for table `tbl_b_uac_user_permissions_r`
--
...
--
-- Table structure for table `tbl_c_uac_location_a_country_p`
--
...
--
-- Table structure for table `tbl_c_uac_location_b_provinces_p`
--
...
--
-- Table structure for table `tbl_c_uac_location_c_cities_p`
--
...
--
-- Table structure for table `tbl_c_uac_location_d_districts_p`
--
...
--
-- Table structure for table `tbl_c_uac_location_e_areas_p`
--
...
--
-- Indexes for table `tbl_a_uac_groups_p`
--
ALTER TABLE `tbl_a_uac_groups_p`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_a_uac_menu_p`
--
ALTER TABLE `tbl_a_uac_menu_p`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_a_uac_modules_p`
--
ALTER TABLE `tbl_a_uac_modules_p`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_a_uac_permissions_p`
--
ALTER TABLE `tbl_a_uac_permissions_p`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_a_uac_users_p`
--
ALTER TABLE `tbl_a_uac_users_p`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_a_uac_user_login_attempts_c`
--
ALTER TABLE `tbl_a_uac_user_login_attempts_c`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_a_uac_user_profiles_c`
--
ALTER TABLE `tbl_a_uac_user_profiles_c`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_a_uac_user_registered_type_c`
--
ALTER TABLE `tbl_a_uac_user_registered_type_c`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_a_uac_user_token_c`
--
ALTER TABLE `tbl_a_uac_user_token_c`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_b_uac_group_permissions_r`
--
ALTER TABLE `tbl_b_uac_group_permissions_r`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_b_uac_menu_permissions_r`
--
ALTER TABLE `tbl_b_uac_menu_permissions_r`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_b_uac_user_group_c`
--
ALTER TABLE `tbl_b_uac_user_group_c`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_b_uac_user_permissions_r`
--
ALTER TABLE `tbl_b_uac_user_permissions_r`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_c_uac_location_a_country_p`
--
ALTER TABLE `tbl_c_uac_location_a_country_p`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_c_uac_location_b_provinces_p`
--
ALTER TABLE `tbl_c_uac_location_b_provinces_p`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_c_uac_location_c_cities_p`
--
ALTER TABLE `tbl_c_uac_location_c_cities_p`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_c_uac_location_d_districts_p`
--
ALTER TABLE `tbl_c_uac_location_d_districts_p`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_c_uac_location_e_areas_p`
--
...
--
ALTER TABLE `cache`
  MODIFY `key` int(32) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_a_uac_groups_p`
--
ALTER TABLE `tbl_a_uac_groups_p`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_a_uac_menu_p`
--
ALTER TABLE `tbl_a_uac_menu_p`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_a_uac_modules_p`
--
ALTER TABLE `tbl_a_uac_modules_p`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_a_uac_permissions_p`
--
ALTER TABLE `tbl_a_uac_permissions_p`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `tbl_a_uac_users_p`
--
ALTER TABLE `tbl_a_uac_users_p`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_a_uac_user_login_attempts_c`
--
ALTER TABLE `tbl_a_uac_user_login_attempts_c`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_a_uac_user_profiles_c`
--
ALTER TABLE `tbl_a_uac_user_profiles_c`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_a_uac_user_registered_type_c`
--
ALTER TABLE `tbl_a_uac_user_registered_type_c`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_a_uac_user_token_c`
--
ALTER TABLE `tbl_a_uac_user_token_c`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_b_uac_group_permissions_r`
--
ALTER TABLE `tbl_b_uac_group_permissions_r`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `tbl_b_uac_menu_permissions_r`
--
ALTER TABLE `tbl_b_uac_menu_permissions_r`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_b_uac_user_group_c`
--
ALTER TABLE `tbl_b_uac_user_group_c`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_b_uac_user_permissions_r`
--
ALTER TABLE `tbl_b_uac_user_permissions_r`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `tbl_c_uac_location_a_country_p`
--
ALTER TABLE `tbl_c_uac_location_a_country_p`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_c_uac_location_b_provinces_p`
--
ALTER TABLE `tbl_c_uac_location_b_provinces_p`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_c_uac_location_c_cities_p`
--
ALTER TABLE `tbl_c_uac_location_c_cities_p`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_c_uac_location_d_districts_p`
--
ALTER TABLE `tbl_c_uac_location_d_districts_p`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_c_uac_location_e_areas_p`
--
ALTER TABLE `tbl_c_uac_location_e_areas_p`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT;
