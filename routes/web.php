    ...
    Route::group(['prefix' => 'master'], function ($e) {
        Route::group(['prefix' => 'uac'], function ($e) {
            Route::group(['prefix' => 'users'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\AccessControl\UserController@@edit')->name('extraweb.prefferences.master.user.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\AccessControl\UserController@@update')->name('extraweb.prefferences.master.user.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\AccessControl\UserController@@delete')->name('extraweb.prefferences.master.user.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\AccessControl\UserController@@remove')->name('extraweb.prefferences.master.user.remove');
            });
            Route::group(['prefix' => 'groups'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\AccessControl\GroupController@edit')->name('extraweb.prefferences.master.group.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\AccessControl\GroupController@update')->name('extraweb.prefferences.master.group.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\AccessControl\GroupController@delete')->name('extraweb.prefferences.master.group.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\AccessControl\GroupController@remove')->name('extraweb.prefferences.master.group.remove');
            });
            Route::group(['prefix' => 'permissions'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\AccessControl\PermissionController@edit')->name('extraweb.prefferences.master.permission.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\AccessControl\PermissionController@update')->name('extraweb.prefferences.master.permission.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\AccessControl\PermissionController@delete')->name('extraweb.prefferences.master.permission.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\AccessControl\PermissionController@remove')->name('extraweb.prefferences.master.permission.remove');
            });
            Route::group(['prefix' => 'menus'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\AccessControl\MenuController@edit')->name('extraweb.prefferences.master.user.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\AccessControl\MenuController@update')->name('extraweb.prefferences.master.user.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\AccessControl\MenuController@delete')->name('extraweb.prefferences.master.user.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\AccessControl\MenuController@remove')->name('extraweb.prefferences.master.user.remove');
            });
        });
        Route::group(['prefix' => 'assets'], function ($e) {
            Route::group(['prefix' => 'currency'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\Assets\CurrencyController@edit')->name('extraweb.prefferences.master.asset.currency.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\Assets\CurrencyController@update')->name('extraweb.prefferences.master.asset.currency.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\Assets\CurrencyController@delete')->name('extraweb.prefferences.master.asset.currency.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\Assets\CurrencyController@remove')->name('extraweb.prefferences.master.asset.currency.remove');
            });
            Route::group(['prefix' => 'icon'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\Assets\IconController@edit')->name('extraweb.prefferences.master.user.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\Assets\IconController@update')->name('extraweb.prefferences.master.user.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\Assets\IconController@delete')->name('extraweb.prefferences.master.user.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\Assets\IconController@remove')->name('extraweb.prefferences.master.user.remove');
            });
            Route::group(['prefix' => 'class'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\Assets\ClassController@edit')->name('extraweb.prefferences.master.user.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\Assets\ClassController@update')->name('extraweb.prefferences.master.user.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\Assets\ClassController@delete')->name('extraweb.prefferences.master.user.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\Assets\ClassController@remove')->name('extraweb.prefferences.master.user.remove');
            });
            Route::group(['prefix' => 'method'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\Assets\MethodController@edit')->name('extraweb.prefferences.master.user.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\Assets\MethodController@update')->name('extraweb.prefferences.master.user.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\Assets\MethodController@delete')->name('extraweb.prefferences.master.user.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\Assets\MethodController@remove')->name('extraweb.prefferences.master.user.remove');
            });
        });
        Route::group(['prefix' => 'locations'], function ($e) {
            Route::group(['prefix' => 'country'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\Locations\CountryController@edit')->name('extraweb.prefferences.master.locations.country.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\Locations\CountryController@update')->name('extraweb.prefferences.master.locations.country.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\Locations\CountryController@delete')->name('extraweb.prefferences.master.locations.country.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\Locations\CountryController@remove')->name('extraweb.prefferences.master.locations.country.remove');
            });
            Route::group(['prefix' => 'provinces'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\Locations\ProvincesController@edit')->name('extraweb.prefferences.master.locations.provinces.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\Locations\ProvincesController@update')->name('extraweb.prefferences.master.locations.provinces.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\Locations\ProvincesController@delete')->name('extraweb.prefferences.master.locations.provinces.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\Locations\ProvincesController@remove')->name('extraweb.prefferences.master.locations.provinces.remove');
            });
            Route::group(['prefix' => 'cities'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\Locations\CitiesController@edit')->name('extraweb.prefferences.master.locations.cities.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\Locations\CitiesController@update')->name('extraweb.prefferences.master.locations.cities.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\Locations\CitiesController@delete')->name('extraweb.prefferences.master.locations.cities.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\Locations\CitiesController@remove')->name('extraweb.prefferences.master.locations.cities.remove');
            });
            Route::group(['prefix' => 'districts'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\Locations\DistrictsController@edit')->name('extraweb.prefferences.master.locations.districts.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\Locations\DistrictsController@update')->name('extraweb.prefferences.master.locations.districts.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\Locations\DistrictsController@delete')->name('extraweb.prefferences.master.locations.districts.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\Locations\DistrictsController@remove')->name('extraweb.prefferences.master.locations.districts.remove');
            });
            Route::group(['prefix' => 'areas'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Master\Locations\AreasController@edit')->name('extraweb.prefferences.master.locations.areas.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Master\Locations\AreasController@update')->name('extraweb.prefferences.master.locations.areas.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Master\Locations\AreasController@delete')->name('extraweb.prefferences.master.locations.areas.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Master\Locations\AreasController@remove')->name('extraweb.prefferences.master.locations.areas.remove');
            });
        });
    });
    Route::group(['prefix' => 'prefferences'], function ($e) {
        Route::group(['prefix' => 'permissions'], function ($e) {
            Route::group(['prefix' => 'user'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Prefferences\Permissions\UserController@edit')->name('extraweb.prefferences.permissionsuser.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Prefferences\Permissions\UserController@update')->name('extraweb.prefferences.permissions.user.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Prefferences\Permissions\UserController@delete')->name('extraweb.prefferences.permissions.user.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Prefferences\Permissions\UserController@remove')->name('extraweb.prefferences.permissions.user.remove');
            });
            Route::group(['prefix' => 'group'], function ($e) {
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Prefferences\Permissions\GroupController@edit')->name('extraweb.prefferences.permissions.group.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Prefferences\Permissions\GroupController@update')->name('extraweb.prefferences.permissions.group.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Prefferences\Permissions\GroupController@delete')->name('extraweb.prefferences.permissions.group.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Prefferences\Permissions\GroupController@remove')->name('extraweb.prefferences.permissions.group.remove');
            });
            Route::group(['prefix' => 'menu'], function ($e) {
               Route::get('view', 'App\Http\Controllers\Backend\Prefferences\Permissions\MenuController@view')->name('extraweb.prefferences.permissions.menu.view');
                ...
                Route::get('edit', 'App\Http\Controllers\Backend\Prefferences\Permissions\MenuController@edit')->name('extraweb.prefferences.permissions.menu.edit');
                Route::post('update', 'App\Http\Controllers\Backend\Prefferences\Permissions\MenuController@update')->name('extraweb.prefferences.permissions.menu.update');
                ...
                Route::post('delete', 'App\Http\Controllers\Backend\Prefferences\Permissions\MenuController@delete')->name('extraweb.prefferences.permissions.menu.delete');
                Route::post('remove', 'App\Http\Controllers\Backend\Prefferences\Permissions\MenuController@remove')->name('extraweb.prefferences.permissions.menu.remove');
            });
        });
