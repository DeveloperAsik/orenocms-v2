...
function h(b,g,c){var j,h;if(!(h=c&&c[b])){if(c=!c)a:{for(c=g.target;c;){if((h=a.data(c,t))&&(!b||h[b]))break a;c=c.parentNode}c=null}h=c}if(h){j=g;var c=j.type,f,D;j=a.Event(j);j.type=b;h=j.originalEvent;f=a.event.props;c.search(/^(mouse|click)/)>-1&&(f=u);if(h)for(D=f.length;D;)b=f[--D],j[b]=h[b];if(c.search(/mouse(down|up)|click/)>-1&&!j.which)j.which=1;if(c.search(/^touch/)!==-1&&(b=e(h),c=b.touches,b=b.changedTouches,c=c&&c.length?c[0]:b&&b.length?b[0]:d))for(h=0,len=x.length;h<len;h++)b=x[h],
j[b]=c[b];a(g.target).trigger(j)}return j}function j(b){var e=a.data(b.target,v);if(!D&&(!G||G!==e))if(e=h("v"+b.type,b))e.isDefaultPrevented()&&b.preventDefault(),e.isPropagationStopped()&&b.stopPropagation(),e.isImmediatePropagationStopped()&&b.stopImmediatePropagation()}function q(b){var c=e(b).touches,g;if(c&&c.length===1&&(g=b.target,c=f(g),c.hasVirtualBinding))G=N++,a.data(g,v,G),z&&(clearTimeout(z),z=0),A=H=false,g=e(b).touches[0],y=g.pageX,s=g.pageY,h("vmouseover",b,c),h("vmousedown",b,c)}
function p(a){H||(A||h("vmousecancel",a,f(a.target)),A=true,g())}function m(b){if(!H){var c=e(b).touches[0],d=A,j=a.vmouse.moveDistanceThreshold;A=A||Math.abs(c.pageX-y)>j||Math.abs(c.pageY-s)>j;flags=f(b.target);A&&!d&&h("vmousecancel",b,flags);h("vmousemove",b,flags);g()}}function w(a){if(!H){H=true;var b=f(a.target),c;h("vmouseup",a,b);if(!A&&(c=h("vclick",a,b))&&c.isDefaultPrevented())c=e(a).changedTouches[0],B.push({touchID:G,x:c.clientX,y:c.clientY}),D=true;h("vmouseout",a,b);A=false;g()}}function n(b){var b=
a.data(b,t),e;if(b)for(e in b)if(b[e])return true;return false}function k(){}function o(b){var e=b.substr(1);return{setup:function(){n(this)||a.data(this,t,{});a.data(this,t)[b]=true;l[b]=(l[b]||0)+1;l[b]===1&&J.bind(e,j);a(this).bind(e,k);if(M)l.touchstart=(l.touchstart||0)+1,l.touchstart===1&&J.bind("touchstart",q).bind("touchend",w).bind("touchmove",m).bind("scroll",p)},teardown:function(){--l[b];l[b]||J.unbind(e,j);M&&(--l.touchstart,l.touchstart||J.unbind("touchstart",q).unbind("touchmove",m).unbind("touchend",
w).unbind("scroll",p));var c=a(this),g=a.data(this,t);g&&(g[b]=false);c.unbind(e,k);n(this)||c.removeData(t)}}}var t="virtualMouseBindings",v="virtualTouchID",c="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),x="clientX clientY pageX pageY screenX screenY".split(" "),u=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),l={},z=0,y=0,s=0,A=false,B=[],D=false,H=false,M="addEventListener"in b,J=a(b),N=1,G=0;a.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,
resetTimerDuration:1500};for(var K=0;K<c.length;K++)a.event.special[c[K]]=o(c[K]);M&&b.addEventListener("click",function(b){var e=B.length,c=b.target,g,d,j,h,f;if(e){g=b.clientX;d=b.clientY;threshold=a.vmouse.clickDistanceThreshold;for(j=c;j;){for(h=0;h<e;h++)if(f=B[h],j===c&&Math.abs(f.x-g)<threshold&&Math.abs(f.y-d)<threshold||a.data(j,v)===f.touchID){b.preventDefault();b.stopPropagation();return}j=j.parentNode}}},true)})(l,s,k);(function(a,c,b){function d(a){a=a||location.href;return"#"+a.replace(/^[^#]*#?(.*)$/,
"$1")}var e="hashchange",f=k,g,h=a.event.special,j=f.documentMode,q="on"+e in c&&(j===b||j>7);a.fn[e]=function(a){return a?this.bind(e,a):this.trigger(e)};a.fn[e].delay=50;h[e]=a.extend(h[e],{setup:function(){if(q)return false;a(g.start)},teardown:function(){if(q)return false;a(g.stop)}});g=function(){function g(){var b=d(),j=t(n);if(b!==n)o(n=b,j),a(c).trigger(e);else if(j!==n)location.href=location.href.replace(/#.*/,"")+j;h=setTimeout(g,a.fn[e].delay)}var j={},h,n=d(),k=function(a){return a},o=
k,t=k;j.start=function(){h||g()};j.stop=function(){h&&clearTimeout(h);h=b};a.browser.msie&&!q&&function(){var b,c;j.start=function(){if(!b)c=(c=a.fn[e].src)&&c+d(),b=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){c||o(d());g()}).attr("src",c||"javascript:0").insertAfter("body")[0].contentWindow,f.onpropertychange=function(){try{if(event.propertyName==="title")b.document.title=f.title}catch(a){}}};j.stop=k;t=function(){return d(b.location.href)};o=function(c,g){var d=b.document,
j=a.fn[e].domain;if(c!==g)d.title=f.title,d.open(),j&&d.write('<script>document.domain="'+j+'"<\/script>'),d.close(),b.location.hash=c}}();return j}()})(l,this);(function(a,c){if(a.cleanData){var b=a.cleanData;a.cleanData=function(c){for(var d=0,g;(g=c[d])!=null;d++)a(g).triggerHandler("remove");b(c)}}else{var d=a.fn.remove;a.fn.remove=function(b,c){return this.each(function(){c||(!b||a.filter(b,[this]).length)&&a("*",this).add([this]).each(function(){a(this).triggerHandler("remove")});return d.call(a(this),
b,c)})}}a.widget=function(b,c,g){var d=b.split(".")[0],j,b=b.split(".")[1];j=d+"-"+b;if(!g)g=c,c=a.Widget;a.expr[":"][j]=function(c){return!!a.data(c,b)};a[d]=a[d]||{};a[d][b]=function(a,b){arguments.length&&this._createWidget(a,b)};c=new c;c.options=a.extend(true,{},c.options);a[d][b].prototype=a.extend(true,c,{namespace:d,widgetName:b,widgetEventPrefix:a[d][b].prototype.widgetEventPrefix||b,widgetBaseClass:j},g);a.widget.bridge(b,a[d][b])};a.widget.bridge=function(b,d){a.fn[b]=function(g){var h=
typeof g==="string",j=Array.prototype.slice.call(arguments,1),q=this,g=!h&&j.length?a.extend.apply(null,[true,g].concat(j)):g;if(h&&g.charAt(0)==="_")return q;h?this.each(function(){var d=a.data(this,b);if(!d)throw"cannot call methods on "+b+" prior to initialization; attempted to call method '"+g+"'";if(!a.isFunction(d[g]))throw"no such method '"+g+"' for "+b+" widget instance";var h=d[g].apply(d,j);if(h!==d&&h!==c)return q=h,false}):this.each(function(){var c=a.data(this,b);c?c.option(g||{})._init():
a.data(this,b,new d(g,this))});return q}};a.Widget=function(a,b){arguments.length&&this._createWidget(a,b)};a.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:false},_createWidget:function(b,c){a.data(c,this.widgetName,this);this.element=a(c);this.options=a.extend(true,{},this.options,this._getCreateOptions(),b);var g=this;this.element.bind("remove."+this.widgetName,function(){g.destroy()});this._create();this._trigger("create");this._init()},_getCreateOptions:function(){var b=
...
a.each(this.options,function(a){var f=b.jqmData(a.replace(/[A-Z]/g,function(a){return"-"+a.toLowerCase()}));f!==c&&(d[a]=f)});return d},enhanceWithin:function(b,c){this.enhance(a(this.options.initSelector,a(b)),c)},enhance:function(b,c){var e,f=a(b),f=a.mobile.enhanceable(f);c&&f.length&&(e=(e=a.mobile.closestPageData(f))&&e.keepNativeSelector()||"",f=f.not(e));f[this.widgetName]()},raise:function(a){throw"Widget ["+this.widgetName+"]: "+a;}})})(l);(function(a,c,b){var d={};a.mobile=a.extend({},{version:"legacy",
...
var e=a.find,f=/:jqmData\(([^)]*)\)/g;a.find=function(b,c,d,q){b=b.replace(f,"[data-"+(a.mobile.ns||"")+"$1]");return e.call(this,b,c,d,q)};a.extend(a.find,e);a.find.matches=function(b,c){return a.find(b,null,null,c)};a.find.matchesSelector=function(b,c){return a.find(c,null,null,[b]).length>0}})(l,this);(function(a){a(s);var c=a("html");a.mobile.media=function(){var b={},d=a("<div id='jquery-mediatest'></div>"),e=a("<body>").append(d);return function(a){if(!(a in b)){var g=k.createElement("style"),
h="@media "+a+" { #jquery-mediatest { position:absolute; } }";g.type="text/css";g.styleSheet?g.styleSheet.cssText=h:g.appendChild(k.createTextNode(h));c.prepend(e).prepend(g);b[a]=d.css("position")==="absolute";e.add(g).remove()}return b[a]}}()})(l);(function(a,c){function b(a){var b=a.charAt(0).toUpperCase()+a.substr(1),a=(a+" "+g.join(b+" ")+b).split(" "),d;for(d in a)if(f[a[d]]!==c)return true}function d(a,b,c){var d=k.createElement("div"),c=c?[c]:g,e;for(i=0;i<c.length;i++){var j=c[i],h="-"+j.charAt(0).toLowerCase()+
j.substr(1)+"-"+a+": "+b+";",j=j.charAt(0).toUpperCase()+j.substr(1)+(a.charAt(0).toUpperCase()+a.substr(1));d.setAttribute("style",h);d.style[j]&&(e=true)}return!!e}var e=a("<body>").prependTo("html"),f=e[0].style,g=["Webkit","Moz","O"],h="palmGetResource"in s,j=s.opera,q=s.operamini&&{}.toString.call(s.operamini)==="[object OperaMini]",p=s.blackberry;a.extend(a.mobile,{browser:{}});a.mobile.browser.ie=function(){for(var a=3,b=k.createElement("div"),c=b.all||[];b.innerHTML="<\!--[if gt IE "+ ++a+
...
(function(a,c,b){var d=function(d){d===b&&(d=true);return function(b,e,j,q){var k=new a.Deferred,m=e?" reverse":"",l=a.mobile.urlHistory.getActive().lastScroll||a.mobile.defaultHomeScroll,n=a.mobile.getScreenHeight(),r=a.mobile.maxTransitionWidth!==false&&a(c).width()>a.mobile.maxTransitionWidth,o=!a.support.cssTransitions||r||!b||b==="none"||Math.max(a(c).scrollTop(),l)>a.mobile.getMaxScrollForTransition(),t=function(){a.mobile.pageContainer.toggleClass("ui-mobile-viewport-transitioning viewport-"+
b)},v=function(){a.event.special.scrollstart.enabled=false;c.scrollTo(0,l);setTimeout(function(){a.event.special.scrollstart.enabled=true},150)},x=function(){q.removeClass(a.mobile.activePageClass+" out in reverse "+b).height("")},r=function(){q&&d&&x();j.css("z-index",-10);j.addClass(a.mobile.activePageClass+" ui-page-pre-in");a.mobile.focusPage(j);j.height(n+l);v();j.css("z-index","");o||j.animationComplete(u);j.removeClass(" ui-page-pre-in").addClass(b+" in"+m);o&&u()},u=function(){d||q&&x();j.removeClass("out in reverse "+
b).height("");t();a(c).scrollTop()!==l&&v();k.resolve(b,e,j,q,true)};t();q&&!o?(d?q.animationComplete(r):r(),q.height(n+a(c).scrollTop()).addClass(b+" out"+m)):r();return k.promise()}},e=d(),d=d(false);a.mobile.defaultTransitionHandler=e;a.mobile.transitionHandlers={"default":a.mobile.defaultTransitionHandler,sequential:e,simultaneous:d};a.mobile.transitionFallbacks={};a.mobile.getMaxScrollForTransition=a.mobile.getMaxScrollForTransition||function(){return a.mobile.getScreenHeight()*3}})(l,this);
(function(a,c){function b(b){l&&(!l.closest(".ui-page-active").length||b)&&l.removeClass(a.mobile.activeBtnClass);l=null}function d(){o=false;r.length>0&&a.mobile.changePage.apply(null,r.pop())}function e(b,c,d,e){c&&c.data("page")._trigger("beforehide",null,{nextPage:b});b.data("page")._trigger("beforeshow",null,{prevPage:c||a("")});a.mobile.hidePageLoadingMsg();d&&!a.support.cssTransform3d&&a.mobile.transitionFallbacks[d]&&(d=a.mobile.transitionFallbacks[d]);d=(a.mobile.transitionHandlers[d||"default"]||
a.mobile.defaultTransitionHandler)(d,e,b,c);d.done(function(){c&&c.data("page")._trigger("hide",null,{nextPage:b});b.data("page")._trigger("show",null,{prevPage:c||a("")})});return d}function f(){var b=a("."+a.mobile.activePageClass),c=parseFloat(b.css("padding-top")),d=parseFloat(b.css("padding-bottom")),e=parseFloat(b.css("border-top-width")),g=parseFloat(b.css("border-bottom-width"));b.css("min-height",z()-c-d-e-g)}function g(b,c){c&&b.attr("data-"+a.mobile.ns+"role",c);b.page()}function h(a){for(;a;){if(typeof a.nodeName===
"string"&&a.nodeName.toLowerCase()=="a")break;a=a.parentNode}return a}function j(b){var b=a(b).closest(".ui-page").jqmData("url"),c=u.hrefNoHash;if(!b||!m.isPath(b))b=c;return m.makeUrlAbsolute(b,c)}var q=a(s);a("html");var p=a("head"),m={urlParseRE:/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,getLocation:function(a){var b=a?this.parseUrl(a):location,a=this.parseUrl(a||
location.href).hash;return b.protocol+"//"+b.host+b.pathname+b.search+(a==="#"?"":a)},parseLocation:function(){return this.parseUrl(this.getLocation())},parseUrl:function(b){if(a.type(b)==="object")return b;b=m.urlParseRE.exec(b||"")||[];return{href:b[0]||"",hrefNoHash:b[1]||"",hrefNoSearch:b[2]||"",domain:b[3]||"",protocol:b[4]||"",doubleSlash:b[5]||"",authority:b[6]||"",username:b[8]||"",password:b[9]||"",host:b[10]||"",hostname:b[11]||"",port:b[12]||"",pathname:b[13]||"",directory:b[14]||"",filename:b[15]||
"",search:b[16]||"",hash:b[17]||""}},makePathAbsolute:function(a,b){if(a&&a.charAt(0)==="/")return a;for(var a=a||"",c=(b=b?b.replace(/^\/|(\/[^\/]*|[^\/]+)$/g,""):"")?b.split("/"):[],d=a.split("/"),e=0;e<d.length;e++){var g=d[e];switch(g){case ".":break;case "..":c.length&&c.pop();break;default:c.push(g)}}return"/"+c.join("/")},isSameDomain:function(a,b){return m.parseUrl(a).domain===m.parseUrl(b).domain},isRelativeUrl:function(a){return m.parseUrl(a).protocol===""},isAbsoluteUrl:function(a){return m.parseUrl(a).protocol!==
""},makeUrlAbsolute:function(a,b){if(!m.isRelativeUrl(a))return a;b===c&&(b=u);var d=m.parseUrl(a),e=m.parseUrl(b),g=d.protocol||e.protocol,h=d.protocol?d.doubleSlash:d.doubleSlash||e.doubleSlash,j=d.authority||e.authority,f=d.pathname!=="",n=m.makePathAbsolute(d.pathname||e.filename,e.pathname);return g+h+j+n+(d.search||!f&&e.search||"")+d.hash},addSearchParams:function(b,c){var d=m.parseUrl(b),e=typeof c==="object"?a.param(c):c,g=d.search||"?";return d.hrefNoSearch+g+(g.charAt(g.length-1)!=="?"?
"&":"")+e+(d.hash||"")},convertUrlToDataUrl:function(a){var b=m.parseUrl(a);if(m.isEmbeddedPage(b))return b.hash.split(t)[0].replace(/^#/,"");else if(m.isSameDomain(b,u))return b.hrefNoHash.replace(u.domain,"").split(t)[0];return a},get:function(a){if(a===c)a=location.hash;return m.stripHash(a).replace(/[^\/]*\.[^\/*]+$/,"")},getFilePath:function(b){var c="&"+a.mobile.subPageUrlKey;return b&&b.split(c)[0].split(t)[0]},set:function(a){location.hash=a},isPath:function(a){return/\//.test(a)},clean:function(a){return a.replace(u.domain,
"")},stripHash:function(a){return a.replace(/^#/,"")},cleanHash:function(a){return m.stripHash(a.replace(/\?.*$/,"").replace(t,""))},isHashValid:function(a){return/^#[^#]+$/.test(a)},isExternal:function(a){a=m.parseUrl(a);return a.protocol&&a.domain!==x.domain?true:false},hasProtocol:function(a){return/^(:?\w+:)/.test(a)},isFirstPageUrl:function(b){var b=m.parseUrl(m.makeUrlAbsolute(b,u)),d=a.mobile.firstPage,d=d&&d[0]?d[0].id:c;return(b.hrefNoHash===x.hrefNoHash||F&&b.hrefNoHash===u.hrefNoHash)&&
(!b.hash||b.hash==="#"||d&&b.hash.replace(/^#/,"")===d)},isEmbeddedPage:function(a){a=m.parseUrl(a);return a.protocol!==""?a.hash&&(a.hrefNoHash===x.hrefNoHash||F&&a.hrefNoHash===u.hrefNoHash):/^#/.test(a.href)},isPermittedCrossDomainRequest:function(b,c){return a.mobile.allowCrossDomainPages&&b.protocol==="file:"&&c.search(/^https?:/)!=-1}},l=null,n={stack:[],activeIndex:0,getActive:function(){return n.stack[n.activeIndex]},getPrev:function(){return n.stack[n.activeIndex-1]},getNext:function(){return n.stack[n.activeIndex+
...
ignoreNextHashChange:false},r=[],o=false,t="&ui-state=dialog",v=p.children("base"),x=m.parseLocation(),u=v.length?m.parseUrl(m.makeUrlAbsolute(v.attr("href"),x.href)):x,F=x.hrefNoHash!==u.hrefNoHash,z=a.mobile.getScreenHeight,y=a.support.dynamicBaseTag?{element:v.length?v:a("<base>",{href:u.hrefNoHash}).prependTo(p),set:function(a){y.element.attr("href",m.makeUrlAbsolute(a,u))},reset:function(){y.element.attr("href",u.hrefNoHash)}}:c;a.mobile.back=function(){var a=s.navigator;this.phonegapNavigationEnabled&&
a&&a.app&&a.app.backHistory?a.app.backHistory():s.history.back()};a.mobile.focusPage=function(a){var b=a.find("[autofocus]"),c=a.find(".ui-title:eq(0)");b.length?b.focus():c.length?c.focus():a.focus()};var E=true,A,B;A=function(){if(E){var b=a.mobile.urlHistory.getActive();if(b){var c=q.scrollTop();b.lastScroll=c<a.mobile.minScrollBack?a.mobile.defaultHomeScroll:c}}};B=function(){setTimeout(A,100)};q.bind(a.support.pushState?"popstate":"hashchange",function(){E=false});q.one(a.support.pushState?"popstate":
"hashchange",function(){E=true});q.one("pagecontainercreate",function(){a.mobile.pageContainer.bind("pagechange",function(){E=true;q.unbind("scrollstop",B);q.bind("scrollstop",B)})});q.bind("scrollstop",B);a.fn.animationComplete=function(b){return a.support.cssTransitions?a(this).one("webkitAnimationEnd animationend",b):(setTimeout(b,0),a(this))};a.mobile.path=m;a.mobile.base=y;a.mobile.urlHistory=n;a.mobile.dialogHashKey=t;a.mobile.allowCrossDomainPages=false;a.mobile.getDocumentUrl=function(b){return b?
a.extend({},x):x.href};a.mobile.getDocumentBase=function(b){return b?a.extend({},u):u.href};a.mobile._bindPageRemove=function(){var b=a(this);!b.data("page").options.domCache&&b.is(":jqmData(external-page='true')")&&b.bind("pagehide.remove",function(){var b=a(this),c=new a.Event("pageremove");b.trigger(c);c.isDefaultPrevented()||b.removeWithDependents()})};a.mobile.loadPage=function(b,d){var e=a.Deferred(),h=a.extend({},a.mobile.loadPage.defaults,d),f=null,n=null,k=m.makeUrlAbsolute(b,a.mobile.activePage&&
...
!m.isSameDomain(x,k)?e.reject(k,d):a.ajax({url:q,type:h.type,data:h.data,dataType:"html",success:function(c,j,x){var l=a("<div></div>"),v=c.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,u=RegExp("\\bdata-"+a.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");RegExp("(<[^>]+\\bdata-"+a.mobile.ns+"role=[\"']?page[\"']?[^>]*>)").test(c)&&RegExp.$1&&u.test(RegExp.$1)&&RegExp.$1&&(b=q=m.getFilePath(RegExp.$1));y&&typeof d.prefetch==="undefined"&&y.set(q);l.get(0).innerHTML=c;f=l.find(":jqmData(role='page'), :jqmData(role='dialog')").first();
f.length||(f=a("<div data-"+a.mobile.ns+"role='page'>"+c.split(/<\/?body[^>]*>/gmi)[1]+"</div>"));v&&!f.jqmData("title")&&(~v.indexOf("&")&&(v=a("<div>"+v+"</div>").text()),f.jqmData("title",v));if(!a.support.dynamicBaseTag){var t=m.get(q);f.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var b=a(this).is("[href]")?"href":a(this).is("[src]")?"src":"action",c=a(this).attr(b),c=c.replace(location.protocol+"//"+location.host+location.pathname,"");/^(\w+:|#|\/)/.test(c)||
a(this).attr(b,t+c)})}f.attr("data-"+a.mobile.ns+"url",m.convertUrlToDataUrl(q)).attr("data-"+a.mobile.ns+"external-page",true).appendTo(h.pageContainer);f.one("pagecreate",a.mobile._bindPageRemove);g(f,h.role);k.indexOf("&"+a.mobile.subPageUrlKey)>-1&&(f=h.pageContainer.children("[data-"+a.mobile.ns+"url='"+p+"']"));h.showLoadMsg&&(clearTimeout(r),a.mobile.hidePageLoadingMsg());o.xhr=x;o.textStatus=j;o.page=f;h.pageContainer.trigger("pageload",o);e.resolve(k,d,f,n)},error:function(b,c,g){y&&y.set(m.get());
...
{transition:c,reverse:false,changeHash:true,fromHashChange:false,role:c,duplicateCachedPage:c,pageContainer:c,showLoadMsg:true,dataUrl:c,fromPage:c,allowSamePageTransition:false};a.mobile.navreadyDeferred=a.Deferred();a.mobile._registerInternalEvents=function(){a(k).delegate("form","submit",function(b){var c=a(this);if(a.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")&&c.jqmHijackable().length){var d=c.attr("method"),e=c.attr("target"),h=c.attr("action");if(!h&&(h=j(c),h===u.hrefNoHash))h=x.hrefNoSearch;
h=m.makeUrlAbsolute(h,j(c));m.isExternal(h)&&!m.isPermittedCrossDomainRequest(x,h)||e||(a.mobile.changePage(h,{type:d&&d.length&&d.toLowerCase()||"get",data:c.serialize(),transition:c.jqmData("transition"),direction:c.jqmData("direction"),reloadPage:true}),b.preventDefault())}});a(k).bind("vclick",function(c){if(!(c.which>1)&&a.mobile.linkBindingEnabled&&(c=h(c.target),a(c).jqmHijackable().length&&c&&m.parseUrl(c.getAttribute("href")||"#").hash!=="#"))b(true),l=a(c).closest(".ui-btn").not(".ui-disabled"),
l.addClass(a.mobile.activeBtnClass)});a(k).bind("click",function(d){if(a.mobile.linkBindingEnabled){var e=h(d.target),f=a(e),g;if(e&&!(d.which>1)&&f.jqmHijackable().length){g=function(){s.setTimeout(function(){b(true)},200)};if(f.is(":jqmData(rel='back')"))return a.mobile.back(),false;var k=j(f),e=m.makeUrlAbsolute(f.attr("href")||"#",k);if(!a.mobile.ajaxEnabled&&!m.isEmbeddedPage(e))g();else{if(e.search("#")!=-1)if(e=e.replace(/[^#]*#/,""))e=m.isPath(e)?m.makeUrlAbsolute(e,k):m.makeUrlAbsolute("#"+
...
a(this),d=c.attr("href");d&&a.inArray(d,b)===-1&&(b.push(d),a.mobile.loadPage(d,{role:c.attr("data-"+a.mobile.ns+"rel"),prefetch:true}))})});a.mobile._handleHashChange=function(b){var d=m.stripHash(b),e={transition:a.mobile.urlHistory.stack.length===0?"none":c,changeHash:false,fromHashChange:true};if(0===n.stack.length)n.initialDst=d;if(!a.mobile.hashListeningEnabled||n.ignoreNextHashChange)n.ignoreNextHashChange=false;else{if(n.stack.length>1&&d.indexOf(t)>-1&&n.initialDst!==d)if(a.mobile.activePage.is(".ui-dialog"))n.directHashChange({currentUrl:d,
either:function(b){var c=a.mobile.urlHistory.getActive();d=c.pageUrl;a.extend(e,{role:c.role,transition:c.transition,reverse:b})}});else{n.directHashChange({currentUrl:d,isBack:function(){a.mobile.back()},isForward:function(){s.history.forward()}});return}d?(d=typeof d==="string"&&!m.isPath(d)?m.makeUrlAbsolute("#"+d,u):d,a.mobile.changePage(d,e)):a.mobile.changePage(a.mobile.firstPage,e)}};q.bind("hashchange",function(){a.mobile._handleHashChange(m.parseLocation().hash)});a(k).bind("pageshow",f);
a(s).bind("throttledresize",f)};a.mobile.navreadyDeferred.done(function(){a.mobile._registerInternalEvents()})})(l);(function(a,c){var b={},d=a(c),e=a.mobile.path.parseLocation(),f=a.Deferred(),g=a.Deferred();a(k).ready(a.proxy(g,"resolve"));a(k).one("mobileinit",a.proxy(f,"resolve"));a.extend(b,{initialFilePath:e.pathname+e.search,hashChangeTimeout:200,hashChangeEnableTimer:C,initialHref:e.hrefNoHash,state:function(){return{hash:a.mobile.path.parseLocation().hash||"#"+b.initialFilePath,title:k.title,
initialHref:b.initialHref}},resetUIKeys:function(b){var c="&"+a.mobile.subPageUrlKey,d=b.indexOf(a.mobile.dialogHashKey);d>-1?b=b.slice(0,d)+"#"+b.slice(d):b.indexOf(c)>-1&&(b=b.split(c).join("#"+c));return b},nextHashChangePrevented:function(c){a.mobile.urlHistory.ignoreNextHashChange=c;b.onHashChangeDisabled=c},onHashChange:function(){if(!b.onHashChangeDisabled){var c,d;c=a.mobile.path.parseLocation().hash;var e=a.mobile.path.isPath(c),f=e?a.mobile.path.getLocation():a.mobile.getDocumentUrl();c=
...
"vclick"?"a":"form"),c;b.length&&!b.jqmData("transition")&&(c=a.mobile.urlHistory.getActive()||{},b.attr("data-"+a.mobile.ns+"transition",c.transition||a.mobile.defaultDialogTransition).attr("data-"+a.mobile.ns+"direction","reverse"))}).bind("pagehide",function(){c._isClosed=false;a(this).find("."+a.mobile.activeBtnClass).not(".ui-slider-bg").removeClass(a.mobile.activeBtnClass)}).bind("pagebeforeshow",function(){c.options.overlayTheme&&c.element.page("removeContainerBackground").page("setContainerBackground",
c.options.overlayTheme)})},close:function(){var c;if(!this._isClosed)this._isClosed=true,a.mobile.hashListeningEnabled?a.mobile.back():(c=a.mobile.urlHistory.getPrev().url,a.mobile.path.isPath(c)||(c=a.mobile.path.makeUrlAbsolute("#"+c)),a.mobile.changePage(c,{changeHash:false,fromHashChange:true}))}});a(k).delegate(a.mobile.dialog.prototype.options.initSelector,"pagecreate",function(){a.mobile.dialog.prototype.enhance(this)})})(l,this);(function(a){a.mobile.page.prototype.options.backBtnText="Back";
a.mobile.page.prototype.options.addBackBtn=false;a.mobile.page.prototype.options.backBtnTheme=null;a.mobile.page.prototype.options.headerTheme="a";a.mobile.page.prototype.options.footerTheme="a";a.mobile.page.prototype.options.contentTheme=null;a(k).bind("pagecreate",function(c){var b=a(c.target),d=b.data("page").options,e=b.jqmData("role"),f=d.theme;a(":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')",b).jqmEnhanceable().each(function(){var c=a(this),h=c.jqmData("role"),
j=c.jqmData("theme"),k=j||d.contentTheme||e==="dialog"&&f,p;c.addClass("ui-"+h);if(h==="header"||h==="footer"){var m=j||(h==="header"?d.headerTheme:d.footerTheme)||f;c.addClass("ui-bar-"+m).attr("role",h==="header"?"banner":"contentinfo");h==="header"&&(j=c.children("a, button"),p=j.hasClass("ui-btn-left"),k=j.hasClass("ui-btn-right"),p=p||j.eq(0).not(".ui-btn-right").addClass("ui-btn-left").length,k||j.eq(1).addClass("ui-btn-right"));d.addBackBtn&&h==="header"&&a(".ui-page").length>1&&b.jqmData("url")!==
a.mobile.path.stripHash(location.hash)&&!p&&a("<a href='javascript:void(0);' class='ui-btn-left' data-"+a.mobile.ns+"rel='back' data-"+a.mobile.ns+"icon='arrow-l'>"+d.backBtnText+"</a>").attr("data-"+a.mobile.ns+"theme",d.backBtnTheme||m).prependTo(c);c.children("h1, h2, h3, h4, h5, h6").addClass("ui-title").attr({role:"heading","aria-level":"1"})}else h==="content"&&(k&&c.addClass("ui-body-"+k),c.attr("role","main"))})})})(l);(function(a){a.fn.fieldcontain=function(){return this.addClass("ui-field-contain ui-body ui-br").contents().filter(function(){return this.nodeType===
3&&!/\S/.test(this.nodeValue)}).remove()};a(k).bind("pagecreate create",function(c){a(":jqmData(role='fieldcontain')",c.target).jqmEnhanceable().fieldcontain()})})(l);(function(a){a.fn.grid=function(c){return this.each(function(){var b=a(this),d=a.extend({grid:null},c),e=b.children(),f={solo:1,a:2,b:3,c:4,d:5},d=d.grid;if(!d)if(e.length<=5)for(var g in f)f[g]===e.length&&(d=g);else d="a",b.addClass("ui-grid-duo");f=f[d];b.addClass("ui-grid-"+d);e.filter(":nth-child("+f+"n+1)").addClass("ui-block-a");
f>1&&e.filter(":nth-child("+f+"n+2)").addClass("ui-block-b");f>2&&e.filter(":nth-child(3n+3)").addClass("ui-block-c");f>3&&e.filter(":nth-child(4n+4)").addClass("ui-block-d");f>4&&e.filter(":nth-child(5n+5)").addClass("ui-block-e")})}})(l);(function(a){a(k).bind("pagecreate create",function(c){a(":jqmData(role='nojs')",c.target).addClass("ui-nojs")})})(l);(function(a,c){function b(a){for(var b;a;){if((b=typeof a.className==="string"&&a.className+" ")&&b.indexOf("ui-btn ")>-1&&b.indexOf("ui-disabled ")<
0)break;a=a.parentNode}return a}a.fn.buttonMarkup=function(b){for(var b=b&&a.type(b)=="object"?b:{},f=0;f<this.length;f++){var g=this.eq(f),h=g[0],j=a.extend({},a.fn.buttonMarkup.defaults,{icon:b.icon!==c?b.icon:g.jqmData("icon"),iconpos:b.iconpos!==c?b.iconpos:g.jqmData("iconpos"),theme:b.theme!==c?b.theme:g.jqmData("theme")||a.mobile.getInheritedTheme(g,"c"),inline:b.inline!==c?b.inline:g.jqmData("inline"),shadow:b.shadow!==c?b.shadow:g.jqmData("shadow"),corners:b.corners!==c?b.corners:g.jqmData("corners"),
iconshadow:b.iconshadow!==c?b.iconshadow:g.jqmData("iconshadow"),mini:b.mini!==c?b.mini:g.jqmData("mini")},b),q="ui-btn-inner",p,m,l,n,r,o;a.each(j,function(b,c){h.setAttribute("data-"+a.mobile.ns+b,c);g.jqmData(b,c)});(o=a.data(h.tagName==="INPUT"||h.tagName==="BUTTON"?h.parentNode:h,"buttonElements"))?(h=o.outer,g=a(h),l=o.inner,n=o.text,a(o.icon).remove(),o.icon=null):(l=k.createElement(j.wrapperEls),n=k.createElement(j.wrapperEls));r=j.icon?k.createElement("span"):null;d&&!o&&d();if(!j.theme)j.theme=
...
o);r&&a.data(r,"buttonElements",o)}return this};a.fn.buttonMarkup.defaults={corners:true,shadow:true,iconshadow:true,wrapperEls:"span"};var d=function(){var c=a.mobile.buttonMarkup.hoverDelay,f,g;a(k).bind({"vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart":function(d){var j,k=a(b(d.target)),d=d.type;if(k.length)if(j=k.attr("data-"+a.mobile.ns+"theme"),d==="vmousedown")a.support.touch?f=setTimeout(function(){k.removeClass("ui-btn-up-"+j).addClass("ui-btn-down-"+j)},c):
...
function(a){var b=e.is(".ui-collapsible-heading-collapsed")?"expand":"collapse";d.trigger(b);a.preventDefault();a.stopPropagation()})}});a(k).bind("pagecreate create",function(c){a.mobile.collapsible.prototype.enhanceWithin(c.target)})})(l);(function(a,c){a.widget("mobile.collapsibleset",a.mobile.widget,{options:{initSelector:":jqmData(role='collapsible-set')"},_create:function(){var b=this.element.addClass("ui-collapsible-set"),d=this.options;if(!d.theme)d.theme=a.mobile.getInheritedTheme(b,"c");
if(!d.contentTheme)d.contentTheme=b.jqmData("content-theme");if(!d.corners)d.corners=b.jqmData("corners")===c?true:false;b.jqmData("collapsiblebound")||b.jqmData("collapsiblebound",true).bind("expand collapse",function(b){var c=b.type==="collapse",b=a(b.target).closest(".ui-collapsible");b.data("collapsible").options.contentTheme&&b.jqmData("collapsible-last")&&(b.find(".ui-collapsible-heading").first().find("a").first().toggleClass("ui-corner-bottom",c).find(".ui-btn-inner").toggleClass("ui-corner-bottom",
...
d=c.find("a:first");d.length||(d=a("<a/>").html(k||q).prependTo(c.empty()));d.attr("href","#"+f)}).listview();m&&d.is(":jqmData(external-page='true')")&&d.data("page").options.domCache===false&&d.unbind("pagehide.remove").bind("pagehide.remove",function(b,c){var f=c.nextPage,g=new a.Event("pageremove");c.nextPage&&(f=f.jqmData("url"),f.indexOf(e+"&"+a.mobile.subPageUrlKey)!==0&&(k.childPages().remove(),d.trigger(g),g.isDefaultPrevented()||d.removeWithDependents()))})},childPages:function(){var b=
this.parentPage.jqmData("url");return a(":jqmData(url^='"+b+"&"+a.mobile.subPageUrlKey+"')")}});a(k).bind("pagecreate create",function(b){a.mobile.listview.prototype.enhanceWithin(b.target)})})(l);(function(a,c){a.widget("mobile.checkboxradio",a.mobile.widget,{options:{theme:null,mini:false,initSelector:"input[type='checkbox'],input[type='radio']"},_create:function(){var b=this,d=this.element,e=this.options,f=a(d).closest("label"),g=f.length?f:a(d).closest("form,fieldset,:jqmData(role='page'),:jqmData(role='dialog')").find("label").filter("[for='"+
d[0].id+"']"),h=d[0].type,f=d.jqmData("mini")||d.closest("form,fieldset").jqmData("mini")||e.mini,j=h+"-on",l=h+"-off",p=d.parents(":jqmData(type='horizontal')").length?c:l,m=d.jqmData("iconpos")||d.closest("form,fieldset").jqmData("iconpos");if(!(h!=="checkbox"&&h!=="radio")){a.extend(this,{label:g,inputtype:h,checkedClass:"ui-"+j+(p?"":" "+a.mobile.activeBtnClass),uncheckedClass:"ui-"+l,checkedicon:"ui-icon-"+j,uncheckedicon:"ui-icon-"+l});if(!e.theme)e.theme=a.mobile.getInheritedTheme(this.element,
...
vclick:function(){var c=a(this);c.is(":checked")?(c.prop("checked",true),b._getInputSet().not(c).prop("checked",false)):c.prop("checked",false);b._updateAll()},focus:function(){g.addClass(a.mobile.focusClass)},blur:function(){g.removeClass(a.mobile.focusClass)}});this.refresh()}},_cacheVals:function(){this._getInputSet().each(function(){a(this).jqmData("cacheVal",this.checked)})},_getInputSet:function(){return this.inputtype==="checkbox"?this.element:this.element.closest("form,fieldset,:jqmData(role='page')").find("input[name='"+
this.element[0].name+"'][type='"+this.inputtype+"']")},_updateAll:function(){var b=this;this._getInputSet().each(function(){var c=a(this);(this.checked||b.inputtype==="checkbox")&&c.trigger("change")}).checkboxradio("refresh")},refresh:function(){var a=this.element[0],c=this.label,e=c.find(".ui-icon");a.checked?(c.addClass(this.checkedClass).removeClass(this.uncheckedClass),e.addClass(this.checkedicon).removeClass(this.uncheckedicon)):(c.removeClass(this.checkedClass).addClass(this.uncheckedClass),
e.removeClass(this.checkedicon).addClass(this.uncheckedicon));a.disabled?this.disable():this.enable()},disable:function(){this.element.prop("disabled",true).parent().addClass("ui-disabled")},enable:function(){this.element.prop("disabled",false).parent().removeClass("ui-disabled")}});a(k).bind("pagecreate create",function(b){a.mobile.checkboxradio.prototype.enhanceWithin(b.target,true)})})(l);(function(a,c){a.widget("mobile.button",a.mobile.widget,{options:{theme:null,icon:null,iconpos:null,corners:true,
shadow:true,iconshadow:true,initSelector:"button, [type='button'], [type='submit'], [type='reset'], [type='image']"},_create:function(){var b=this.element,d,e=this.options,f;f=e.inline||b.jqmData("inline");var g=e.mini||b.jqmData("mini"),h="",j;if(b[0].tagName==="A")!b.hasClass("ui-btn")&&b.buttonMarkup();else{if(!this.options.theme)this.options.theme=a.mobile.getInheritedTheme(this.element,"c");~b[0].className.indexOf("ui-btn-left")&&(h="ui-btn-left");~b[0].className.indexOf("ui-btn-right")&&(h=
...
a("label[for='"+this.selectID+"']").addClass("ui-select");this.isMultiple=this.select[0].multiple;if(!this.options.theme)this.options.theme=a.mobile.getInheritedTheme(this.select,"c")},_create:function(){this._preExtension();this._trigger("beforeCreate");this.button=this._button();var c=this,b=this.options,d=b.inline||this.select.jqmData("inline"),e=b.mini||this.select.jqmData("mini"),f=b.icon?b.iconpos||this.select.jqmData("iconpos"):false,d=this.button.insertBefore(this.select).buttonMarkup({theme:b.theme,
icon:b.icon,iconpos:f,inline:d,corners:b.corners,shadow:b.shadow,iconshadow:b.iconshadow,mini:e});this.setButtonText();b.nativeMenu&&s.opera&&s.opera.version&&d.addClass("ui-select-nativeonly");if(this.isMultiple)this.buttonCount=a("<span>").addClass("ui-li-count ui-btn-up-c ui-btn-corner-all").hide().appendTo(d.addClass("ui-li-has-count"));(b.disabled||this.element.attr("disabled"))&&this.disable();this.select.change(function(){c.refresh()});this.build()},build:function(){var c=this;this.select.appendTo(c.button).bind("vmousedown",
...
href:"#","class":"ui-btn-left"}).attr("data-"+a.mobile.ns+"iconpos","notext").attr("data-"+a.mobile.ns+"icon","delete").appendTo(r).buttonMarkup());a.extend(b,{select:b.select,selectID:c,buttonId:l,menuId:p,thisPage:f,menuPage:m,label:e,screen:g,selectOptions:h,isMultiple:j,theme:b.options.theme,listbox:w,list:n,header:r,headerTitle:o,headerClose:t,menuPageContent:void 0,menuPageClose:void 0,placeholder:"",build:function(){var c=this;c.refresh();c.select.attr("tabindex","-1").focus(function(){a(this).blur();
c.button.focus()});c.button.bind("vclick keydown",function(b){if(b.type=="vclick"||b.keyCode&&(b.keyCode===a.mobile.keyCode.ENTER||b.keyCode===a.mobile.keyCode.SPACE))c.open(),b.preventDefault()});c.list.attr("role","listbox").bind("focusin",function(b){a(b.target).attr("tabindex","0").trigger("vmouseover")}).bind("focusout",function(b){a(b.target).attr("tabindex","-1").trigger("vmouseout")}).delegate("li:not(.ui-disabled, .ui-li-divider)","click",function(d){var e=c.select[0].selectedIndex,f=c.list.find("li:not(.ui-li-divider)").index(this),
...
c.setButtonCount();c.list.find("li:not(.ui-li-divider)").removeClass(a.mobile.activeBtnClass).attr("aria-selected",false).each(function(b){a.inArray(b,d)>-1&&(b=a(this),b.attr("aria-selected",true),c.isMultiple?b.find(".ui-icon").removeClass("ui-icon-checkbox-off").addClass("ui-icon-checkbox-on"):b.is(".ui-selectmenu-placeholder")?b.next().addClass(a.mobile.activeBtnClass):b.addClass(a.mobile.activeBtnClass))})},close:function(){if(!this.options.disabled&&this.isOpen)this.menuType=="page"?a.mobile.back():
(this.screen.addClass("ui-screen-hidden"),this.listbox.addClass("ui-selectmenu-hidden").removeAttr("style").removeClass("in"),this.list.appendTo(this.listbox),this._focusButton()),this.isOpen=false},open:function(){function c(){var e=d.list.find("."+a.mobile.activeBtnClass+" a");e.length===0&&(e=d.list.find("li.ui-btn:not(:jqmData(placeholder='true')) a"));e.first().focus().closest("li").addClass("ui-btn-down-"+b.options.theme)}if(!this.options.disabled){var d=this,e=a(s),f=d.list.parent(),g=f.outerHeight(),
f=f.outerWidth();a(".ui-page-active");var h=e.scrollTop(),j=d.button.offset().top,l=e.height(),e=e.width();d.button.addClass(a.mobile.activeBtnClass);setTimeout(function(){d.button.removeClass(a.mobile.activeBtnClass)},300);if(g>l-80||!a.support.scrollTop){d.menuPage.appendTo(a.mobile.pageContainer).page();d.menuPageContent=m.find(".ui-content");d.menuPageClose=m.find(".ui-header a");d.thisPage.unbind("pagehide.remove");if(h==0&&j>l)d.thisPage.one("pagehide",function(){a(this).jqmData("lastScroll",
j)});d.menuPage.one("pageshow",function(){c();d.isOpen=true}).one("pagehide",function(){d.isOpen=false});d.menuType="page";d.menuPageContent.append(d.list);d.menuPage.find("div .ui-title").text(d.label.text());a.mobile.changePage(d.menuPage,{transition:a.mobile.defaultDialogTransition})}else{d.menuType="overlay";d.screen.height(a(k).height()).removeClass("ui-screen-hidden");var n=j-h,o=h+l-j,p=g/2,q=parseFloat(d.list.parent().css("max-width")),g=n>g/2&&o>g/2?j+d.button.outerHeight()/2-p:n>o?h+l-g-
30:h+30;f<q?h=(e-f)/2:(h=d.button.offset().left+d.button.outerWidth()/2-f/2,h<30?h=30:h+f>e&&(h=e-f-30));d.listbox.append(d.list).removeClass("ui-selectmenu-hidden").css({top:g,left:h}).addClass("in");c();d.isOpen=true}}},_buildList:function(){var b=this.options,c=this.placeholder,d=true,e=this.isMultiple?"checkbox-off":"false";this.list.empty().filter(".ui-listview").listview("destroy");var f=this.select.find("option"),g=f.length,h=this.select[0],j="data-"+a.mobile.ns,l=j+"option-index",m=j+"icon",
n=j+"role";j+="placeholder";for(var o=k.createDocumentFragment(),p=false,q,s=0;s<g;s++,p=false){var t=f[s],r=a(t),w=t.parentNode,C=r.text(),I=k.createElement("a"),L=[];I.setAttribute("href","#");I.appendChild(k.createTextNode(C));w!==h&&w.nodeName.toLowerCase()==="optgroup"&&(w=w.getAttribute("label"),w!=q&&(q=k.createElement("li"),q.setAttribute(n,"list-divider"),q.setAttribute("role","option"),q.setAttribute("tabindex","-1"),q.appendChild(k.createTextNode(w)),o.appendChild(q),q=w));if(d&&(!t.getAttribute("value")||
C.length==0||r.jqmData("placeholder")))if(d=false,p=true,t.setAttribute(j,true),b.hidePlaceholderMenuItems&&L.push("ui-selectmenu-placeholder"),!c)c=this.placeholder=C;r=k.createElement("li");t.disabled&&(L.push("ui-disabled"),r.setAttribute("aria-disabled",true));r.setAttribute(l,s);r.setAttribute(m,e);p&&r.setAttribute(j,true);r.className=L.join(" ");r.setAttribute("role","option");I.setAttribute("tabindex","-1");r.appendChild(I);o.appendChild(r)}this.list[0].appendChild(o);!this.isMultiple&&!c.length?
...
function(){var d=this;c.updatePagePadding(d);b.updatePagePadding&&a(s).bind("throttledresize."+c.widgetName,function(){c.updatePagePadding(d)})}).bind("pagebeforehide",function(d,e){b.disablePageZoom&&a.mobile.zoom.enable(true);b.updatePagePadding&&a(s).unbind("throttledresize."+c.widgetName);if(b.trackPersistentToolbars){var f=a(".ui-footer-fixed:jqmData(id)",this),g=a(".ui-header-fixed:jqmData(id)",this),h=f.length&&e.nextPage&&a(".ui-footer-fixed:jqmData(id='"+f.jqmData("id")+"')",e.nextPage),
j=g.length&&e.nextPage&&a(".ui-header-fixed:jqmData(id='"+g.jqmData("id")+"')",e.nextPage),h=h||a();if(h.length||j.length)h.add(j).appendTo(a.mobile.pageContainer),e.nextPage.one("pageshow",function(){h.add(j).appendTo(this)})}})},_visible:true,updatePagePadding:function(c){var b=this.element,d=b.is(".ui-header");this.options.fullscreen||(c=c||b.closest(".ui-page"),a(c).css("padding-"+(d?"top":"bottom"),b.outerHeight()))},_useTransition:function(c){var b=this.element,d=a(s).scrollTop(),e=b.height(),
f=b.closest(".ui-page").height(),g=a.mobile.getScreenHeight(),b=b.is(":jqmData(role='header')")?"header":"footer";return!c&&(this.options.transition&&this.options.transition!=="none"&&(b==="header"&&!this.options.fullscreen&&d>e||b==="footer"&&!this.options.fullscreen&&d+g<f-e)||this.options.fullscreen)},show:function(a){var b=this.element;this._useTransition(a)?b.removeClass("out ui-fixed-hidden").addClass("in"):b.removeClass("ui-fixed-hidden");this._visible=true},hide:function(a){var b=this.element,
...
a(k).bind("pagecreate create",function(c){a(c.target).jqmData("fullscreen")&&a(a.mobile.fixedtoolbar.prototype.options.initSelector,c.target).not(":jqmData(fullscreen)").jqmData("fullscreen",true);a.mobile.fixedtoolbar.prototype.enhanceWithin(c.target)})})(l);(function(a,c){if(/iPhone|iPad|iPod/.test(navigator.platform)&&navigator.userAgent.indexOf("AppleWebKit")>-1){var b=a.mobile.zoom,d,e,f,g,h;a(c).bind("orientationchange.iosorientationfix",b.enable).bind("devicemotion.iosorientationfix",function(a){d=
a.originalEvent;h=d.accelerationIncludingGravity;e=Math.abs(h.x);f=Math.abs(h.y);g=Math.abs(h.z);!c.orientation&&(e>7||(g>6&&f<8||g<8&&f>6)&&e>5)?b.enabled&&b.disable():b.enabled||b.enable()})}})(l,this);(function(a,c){function b(){var b=a("."+a.mobile.activeBtnClass).first();h.css({top:a.support.scrollTop&&g.scrollTop()+g.height()/2||b.length&&b.offset().top||100})}function d(){var c=h.offset(),e=g.scrollTop(),f=a.mobile.getScreenHeight();if(c.top<e||c.top-e>f)h.addClass("ui-loader-fakefix"),b(),
g.unbind("scroll",d).bind("scroll",b)}function e(){f.removeClass("ui-mobile-rendering")}var f=a("html");a("head");var g=a(c);a(c.document).trigger("mobileinit");if(a.mobile.gradeA()){if(a.mobile.ajaxBlacklist)a.mobile.ajaxEnabled=false;f.addClass("ui-mobile ui-mobile-rendering");setTimeout(e,5E3);var h=a("<div class='ui-loader'><span class='ui-icon ui-icon-loading'></span><h1></h1></div>");a.extend(a.mobile,{showPageLoadingMsg:function(b,c,e){f.addClass("ui-loading");if(a.mobile.loadingMessage){var k=
e||a.mobile.loadingMessageTextVisible;b=b||a.mobile.loadingMessageTheme;h.attr("class","ui-loader ui-corner-all ui-body-"+(b||"a")+" ui-loader-"+(k?"verbose":"default")+(e?" ui-loader-textonly":"")).find("h1").text(c||a.mobile.loadingMessage).end().appendTo(a.mobile.pageContainer);d();g.bind("scroll",d)}},hidePageLoadingMsg:function(){f.removeClass("ui-loading");a.mobile.loadingMessage&&h.removeClass("ui-loader-fakefix");a(c).unbind("scroll",b);a(c).unbind("scroll",d)},initializePage:function(){var b=
...
!a(location.hash+':jqmData(role="page")').length&&!a.mobile.path.isPath(location.hash)?a.mobile.changePage(a.mobile.firstPage,{transition:"none",reverse:true,changeHash:false,fromHashChange:true}):g.trigger("hashchange",[true])}});a.mobile.navreadyDeferred.resolve();a(function(){c.scrollTo(0,1);a.mobile.defaultHomeScroll=!a.support.scrollTop||a(c).scrollTop()===1?0:1;a.fn.controlgroup&&a(k).bind("pagecreate create",function(b){a(":jqmData(role='controlgroup')",b.target).jqmEnhanceable().controlgroup({excludeInvisible:false})});
a.mobile.autoInitializePage&&a.mobile.initializePage();g.load(a.mobile.silentScroll);a.support.cssPointerEvents||a(k).delegate(".ui-disabled","vclick",function(a){a.preventDefault();a.stopImmediatePropagation()})})}})(l,this)});
